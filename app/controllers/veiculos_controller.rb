class VeiculosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @veiculo.save
        format.html { redirect_to veiculos_url, notice: 'Veiculo foi criado com sucesso.' }
  ...
  def destroy
    @veiculo.destroy
    respond_to do |format|
      format.html { redirect_to veiculos_url, notice: 'Veiculo foi removido com sucesso.' }
