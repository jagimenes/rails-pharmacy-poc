class FormulasController < ApplicationController
  ...
  private
    ...
    def formula_params
      params.require(:formula).permit(:nome, :veiculo_id, :especialidade_id, :observacoes, :quantidade, :unidade_id, :editar, ingredientes_attributes: [:id, :especialidade_id, :quantidade, :_destroy, :produto_id, :unidade_id ] )
    end
end
